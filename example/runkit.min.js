(function (global) {var process;(function (entrypoint, files, compilations, implicitRequires)
    ...
    "function"==typeof Object.getOwnPropertySymbols&&(o=o.concat(Object.getOwnPropertySymbols(t).filter(function(n){return Object.getOwnPropertyDescriptor(t,n).enumerable}))),o.forEach(function(e){r(n,e,t[e])})}return n}function r(n,e,t){return e in n?Object.defineProperty(n,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):n[e]=t,n}var i=e(0),a=window.location.origin,c="".concat(i.origin)+"/e/application-sha256-c0069b937242261ce5a055c3ca077ed30f5346095b6366dc80fdbec9d86c422e"+"#".concat(encodeURIComponent(a))
    ...
    if(f.spent<=f.allowed){var a=Date.now(),l="".concat(u.origin,"/e/iframe-sha256-fcdb29c5b83a65a575fcb72070071b53cf38d094f3b0dfad926f762d8cc8c218"),d="runkit-embed-".concat(n),v=r.element,g=r.style,y=u.iframe(v,{src:l,name:d,style:g})
